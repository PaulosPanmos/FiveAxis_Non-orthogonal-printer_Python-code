...
Numerical inverse kinematics for the femoral-joint benchmark.
...
Multiple B/C seeds are checked to reduce branch switching near the dome top.
    ...
    for k in range(n_rows):
        ...
        if k == 0:
            ...
            if d_prev is not None and np.linalg.norm(d_des_world - d_prev) < IK_DIR_HOLD_EPS:
                ...
                # Use several seeds to reduce branch switching near the dome top.
                ...
                for seed in seeds:
                    ...
                    # Clamp the returned candidate to the configured C range.
